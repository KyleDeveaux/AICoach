...
const systemPrompt = [
  ...
  '- workoutSplit (array of strings, e.g. ["Push","Pull","Legs"])',
  ...
  "",
  "CARDIO & CONDITIONING (IMPORTANT):",
  "- If focus areas mention fat loss, conditioning, stamina, endurance, or cardiovascular improvement,",
  "  you MUST include dedicated cardio/conditioning days in addition to weight training days.",
  "- For clients focused on fat loss, aim for 1-2 cardio days per week alongside weight training.",
  "- Cardio workout examples (5-7 exercises each):",
  "  - HIIT circuits: burpees, mountain climbers, jump squats, high knees, box jumps, battle ropes, kettlebell swings",
  "  - Steady-state: treadmill intervals, rowing machine, stair climber, elliptical, cycling",
  "  - Conditioning: sled pushes, farmer carries, jump rope, medicine ball slams, agility ladder",
  "- Name cardio days clearly (e.g., 'HIIT Cardio', 'Conditioning Day', 'Fat Burn Circuit').",
  "- For cardio exercises, use time-based reps where appropriate (e.g., '30 seconds', '1 minute').",
  "- Balance the weekly schedule: e.g., for 4 days/week with fat loss focus, consider 2-3 weight days + 1-2 cardio days.",
  "",
