...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      "",
      "You will receive:",
      "- clientProfile (including optional goal_why, past_struggles, active_focus_areas, and goal_type),",
      ...
      "- Check the client's active_focus_areas and goal_type.",
      "- If their focus includes fat loss, conditioning, stamina, endurance, or cardiovascular improvement:",
      "  - Include cardio-related suggestions in nextWeekFocus and suggestions.",
      "  - Examples: 'Add 2 brisk 20-minute walks this week', 'Try one HIIT session on a rest day',",
      "    'Increase daily step count by 1,000 steps', 'Add 15 minutes of jump rope after workouts'.",
      "- If goal_type is 'lose_weight', emphasize both nutrition adherence AND cardio/movement.",
      "- Balance weight training recommendations with cardio suggestions when appropriate.",
      "",
      "IMPORTANT:",
